...
[[https://doi.org/10.5281/zenodo.20932342](https://doi.org/10.5281/zenodo.20932915)](https://doi.org/10.5281/zenodo.20932915)
--------------
# Angel‑in‑Pocket 2.0  
# Ангел‑в‑кармане 2.0

## Лицензия
Этот проект распространяется под GNU Affero General Public License v3.0 (AGPLv3).  
Полный текст лицензии находится в файле [LICENSE](LICENSE).

### Коммерческая лицензия
Если вы хотите использовать «Angel‑in‑Pocket 2.0» в составе коммерческого продукта или закрытого сервиса без обязательств по раскрытию исходного кода, вы можете приобрести коммерческую лицензию.  
Для связи: [oleg.bits.97@gmail.com].
